...
const T = {
  fa: {
    ...
    back: "بازگشت به خانه",
    selected: "دپارتمان انتخاب شد:",
    depts: [
      { t: "طراحی و مهندسی", d: "طراحی خودرو، CAD، شبیه‌سازی و توسعه محصول", i: "fa-drafting-compass", c: "#3b82f6" },
      { t: "تولید و مونتاژ", d: "خط تولید، مونتاژ نهایی و کنترل ظرفیت", i: "fa-industry", c: "#ef4444" },
      { t: "کنترل کیفیت", d: "بازرسی، تست عملکرد و تضمین کیفیت محصول", i: "fa-clipboard-check", c: "#10b981" },
      { t: "زنجیره تأمین", d: "مدیریت تأمین‌کنندگان، خرید و لجستیک قطعات", i: "fa-truck", c: "#f59e0b" },
      { t: "تحقیق و توسعه", d: "نوآوری، خودروهای الکتریکی و فناوری‌های نوین", i: "fa-flask", c: "#8b5cf6" },
      { t: "ایمنی و محیط زیست", d: "HSE، ISO 14001 و ISO 45001", i: "fa-shield-heart", c: "#14b8a6" },
      { t: "فروش و بازاریابی", d: "نمایندگی‌ها، تبلیغات و خدمات پس از فروش", i: "fa-chart-line", c: "#ec4899" },
      { t: "منابع انسانی", d: "استخدام، آموزش و توسعه نیروی انسانی", i: "fa-users", c: "#0ea5e9" },
      { t: "مالی و اداری", d: "حسابداری، بودجه و امور اداری", i: "fa-coins", c: "#84cc16" },
    ],
  },
  en: {
    ...
    depts: [
      { t: "Design & Engineering", d: "Vehicle design, CAD, simulation and product development", i: "fa-drafting-compass", c: "#3b82f6" },
      { t: "Production & Assembly", d: "Production line, final assembly and capacity control", i: "fa-industry", c: "#ef4444" },
      { t: "Quality Control", d: "Inspection, performance testing and quality assurance", i: "fa-clipboard-check", c: "#10b981" },
      { t: "Supply Chain", d: "Supplier management, procurement and parts logistics", i: "fa-truck", c: "#f59e0b" },
      { t: "Research & Development", d: "Innovation, EVs and emerging technologies", i: "fa-flask", c: "#8b5cf6" },
      { t: "Safety & Environment", d: "HSE, ISO 14001 and ISO 45001", i: "fa-shield-heart", c: "#14b8a6" },
      { t: "Sales & Marketing", d: "Dealerships, advertising and after-sales service", i: "fa-chart-line", c: "#ec4899" },
      { t: "Human Resources", d: "Recruitment, training and workforce development", i: "fa-users", c: "#0ea5e9" },
      { t: "Finance & Admin", d: "Accounting, budgeting and administration", i: "fa-coins", c: "#84cc16" },
    ],
  },
  zh: {
    title: "选择部门",
    ...
    selected: "已选择部门：",
    depts: [
      { t: "设计与工程", d: "汽车设计、CAD、仿真与产品开发", i: "fa-drafting-compass", c: "#3b82f6" },
      { t: "生产与装配", d: "生产线、总装和产能控制", i: "fa-industry", c: "#ef4444" },
      { t: "质量控制", d: "检验、性能测试与质量保证", i: "fa-clipboard-check", c: "#10b981" },
      { t: "供应链", d: "供应商管理、采购与零件物流", i: "fa-truck", c: "#f59e0b" },
      { t: "研发", d: "创新、电动汽车与新兴技术", i: "fa-flask", c: "#8b5cf6" },
      { t: "安全与环境", d: "HSE、ISO 14001 与 ISO 45001", i: "fa-shield-heart", c: "#14b8a6" },
      { t: "销售与市场", d: "经销商、广告与售后服务", i: "fa-chart-line", c: "#ec4899" },
      { t: "人力资源", d: "招聘、培训与人才发展", i: "fa-users", c: "#0ea5e9" },
      { t: "财务与行政", d: "会计、预算与行政管理", i: "fa-coins", c: "#84cc16" },
    ],
  },
};
      ...
      <header className="dept-header">
        <div className="dept-container dept-header-inner">
          ...
          <div className="dept-tools">
            <button className="dept-back" onClick={() => navigate({ to: "/" })}>
              <i className="fas fa-home" /> <span className="dept-back-lbl">{t.back}</span>
            </button>
            <HeaderDate />
            <LangSwitch />
            <UserMenu />
...
.dept-tools{display:flex;align-items:center;gap:.6rem;flex-wrap:wrap}
.dept-back{display:inline-flex;align-items:center;gap:.45rem;padding:.5rem .9rem;border-radius:10px;font-size:.82rem;font-weight:600;cursor:pointer;border:1px solid rgba(12,27,51,.10);background:#fff;color:#0c1b33;font-family:inherit}
.dept-back:hover{border-color:#1e6cf3;color:#1e6cf3}
...
@media(max-width:640px){.dept-back-lbl{display:none}}
`;
